...
public class Task implements Cloneable {
    ...
    private String name;
    // private Map<Date, String> descriptions = new TreeMap<>((o1, o2) ->
    // o1.after(o2) ? 1 : -1);
    ...
    public String toString() {
        return "Task{" + "taskId='" + taskId + '\'' + ", name='" + name + '\'' + ", descriptions=" + descriptions
                + ", state=" + state + ", time=" + time + ", count=" + count + ", callbackURL='" + callbackURL + '\''
                + ", callbackPara='" + callbackPara + '\'' + ", period=" + period + ", timeUnit=" + timeUnit
                + ", extraInfo=" + extraInfo + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(getTaskId(), task.getTaskId()).append(getName(), task.getName()).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(getTaskId()).append(getName()).toHashCode();
    }
}
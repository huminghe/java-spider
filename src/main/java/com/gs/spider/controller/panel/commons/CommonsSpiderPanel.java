...
public class CommonsSpiderPanel extends BaseController {
    ...
    public String createQuartz(String spiderInfoId, int minutesInterval, RedirectAttributes redirectAttributes) {
        commonsSpiderService.createQuartzJob(spiderInfoId, minutesInterval);

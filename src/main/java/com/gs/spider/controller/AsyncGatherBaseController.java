...
/**
 * AsyncGatherBaseController 异步抓取器的Controller
 */
public class AsyncGatherBaseController extends BaseController {

    private AsyncGatherService asyncGatherService;

    private Logger logger = LogManager.getLogger(AsyncGatherBaseController.class);
    ...
    @ResponseBody
    public ResultListBundle<Task> listTasks(
            @RequestParam(value = "containsExtraInfo", required = false, defaultValue = "false") boolean containsExtraInfo)
            throws IOException {
    ...
    @ResponseBody
    public ResultBundle<Task> getTaskById(String taskId,
                                          @RequestParam(value = "containsExtraInfo", required = false, defaultValue = "true") boolean containsExtraInfo)
            throws IOException {
    ...
    @ResponseBody
    public ResultListBundle<Task> getTasksFilterByState(State state,
                                                        @RequestParam(value = "containsExtraInfo", required = false, defaultValue = "false") boolean containsExtraInfo) {
    ...
    @ResponseBody
    public ResultListBundle<Task> getTasksFilterByTime(long start, long end,
                                                       @RequestParam(value = "containsExtraInfo", required = false, defaultValue = "false") boolean containsExtraInfo) {
